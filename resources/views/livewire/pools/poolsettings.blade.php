            ...
            <div class="space-y-6">
                ...
                <div class="card p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea wire:model="description" rows="3" class="input-field resize-none"
                                  placeholder="Descrição visível para os participantes..."></textarea>
                        @error('description') <p class="mt-1.5 text-xs text-red-400">{{ $message }}</p> @enderror
                    </div>

                    <div>
                        <label class="label">Instruções / Regulamento</label>
                        <textarea wire:model="instructions" rows="5" class="input-field resize-none"
                                  placeholder="Regras de desempate, premiação, critérios especiais..."></textarea>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select wire:model="status" class="select-field">
                ...
                <div class="card p-6 space-y-4">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-1">
                            Defina categorias para organizar os participantes. Membros podem selecionar seu setor.
                        </p>
                    </div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button type="button" wire:click="addSector" class="btn-secondary shrink-0">
            ...
            <div class="space-y-6">
                ...
                <div class="card p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="number" min="10" wire:model="prediction_lock_minutes" class="input-field">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500">Membros podem editar até o bloqueio</p>
                            </div>
                        </label>
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500">Membros em aprovação podem enviar palpites</p>
                            </div>
                        </label>
                    </div>
                    ...
                    <div class="rounded-xl border border-slate-700/70 bg-pitch-900/40 p-4 space-y-4">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">
                                Cada grupo pode ter sua pontuação própria. Ao salvar, o sistema recalcula os pontos e o ranking.
                            </p>
                        </div>
                    ...
                    <div class="rounded-xl border border-slate-700/70 bg-pitch-900/40 p-4 space-y-4">
                        ...
                        >
                            ...
                            <div wire:key="tie-breaker-{{ $criterion }}"
        ...
        <div class="grid gap-6 xl:grid-cols-2 xl:items-start">
            <div class="card p-5 flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Compartilhe para que novos membros entrem</p>
                </div>
                <span class="font-mono text-xl font-bold text-emerald-400 tracking-widest">{{ $pool->invite_code }}</span>
            </div>

            {{-- Actions --}}
            <div class="card p-5 flex items-center justify-end gap-3">
                <a href="{{ route('pools.show', $pool->slug) }}" class="btn-ghost">Cancelar</a>
