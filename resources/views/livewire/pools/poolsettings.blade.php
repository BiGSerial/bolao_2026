    ...
    <form wire:submit="save" class="max-w-2xl space-y-6">
        ...
        <div class="card p-6 space-y-5">
            ...
            <div>
                ...
                <input type="number" min="120" wire:model="prediction_lock_minutes" class="input-field">
                <p class="mt-1 text-xs text-slate-600">Mínimo: 120 minutos</p>
            ...
            <div class="rounded-xl border border-slate-700/70 bg-pitch-900/40 p-4 space-y-4">
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-500">
                        Opcional. Defina e ordene as prioridades de desempate no ranking arrastando os itens.
                    </p>
                </div>
