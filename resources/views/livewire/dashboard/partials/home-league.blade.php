...
<div class="grid gap-5 px-4 md:px-6 pt-5 pb-4 lg:grid-cols-2">
        ...
        <div class="bg-bolao-bg2 border border-white/[0.07] rounded-xl overflow-hidden">
            <table class="min-w-full text-xs">
                ...
                <tbody class="divide-y divide-white/[0.04]">
                    @foreach($standingRows->take(10) as $row)
                    @php
                        $pos = $loop->iteration;
                    ...
                    <tr class="hover:bg-bolao-bg3 transition-colors">
                        ...
                        <td class="px-2 py-2">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-slate-200 truncate max-w-[6rem]" title="{{ $row->team?->name }}">
            ...
            @if($standingRows->count() > 10)
            <div class="px-3 py-2 border-t border-white/[0.04] text-center">
                <span class="text-[10px] text-bolao-muted">+{{ $standingRows->count() - 10 }} times</span>
            </div>
            @endif
        </div>
